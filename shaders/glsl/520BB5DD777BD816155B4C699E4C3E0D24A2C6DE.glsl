...
uniform   mediump float circleRayIn;
uniform   mediump float circleRayOut;
...
void main()
{
	mediump float distanceFromCenter = length(v0c);
	mediump float w1 = 0.2 * smoothstep(circleRayIn, circleRayOut, distanceFromCenter);
